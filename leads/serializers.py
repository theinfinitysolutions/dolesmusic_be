...
class LeadSerializer(serializers.Serializer):
    ...
    campaign = serializers.CharField(max_length=100, required=False)
    adset = serializers.CharField(max_length=100, required=False)
    placement = serializers.CharField(max_length=100, required=False)
    ad = serializers.CharField(max_length=100, required=False)